    ...
    <section class="main">
		<div class="wrapp">
			<div class="mensaje">
                ...
                <p style="text-align:right; text-size: 18px;"><strong>Editar Usuario</strong></p>
			</div>
 
			<div class="articulo">
				<article><h1>Editar Usuario</h1>
					<form name="nuevo_usuario" onSubmit="return formulario()" action="update_usr.php"method="POST">
						<table class="table table-condensed"><?php
							...
							<tr>
								...
								<td> <input type='password' name='passwd' id='passwd' size='20' placeholder='Actualice su contrase&ntilde;a'></td>
							</tr>

							<tr>
								<td> <label>Re-Password</label></td>
								<td><input type='password' name='passwd2' id='passwd2' size='20' placeholder='Re-ingrese su contrase&ntilde;a'></td>
							</tr>


							<tr>
								<td></td>
								<td><button type='submit' class='btn btn-outline btn-success'>Actualizar</button></td>
							</tr>
							"; ?>
						</table>
					</form>
